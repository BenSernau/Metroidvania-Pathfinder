...
5. Pass one of the demo graphs into the dialogue or create your own (e.g., "map0.graph").
...
- **currMsg** stores the current message to the user.
- **displayMsg** determines whether to print currMsg in the terminal.
